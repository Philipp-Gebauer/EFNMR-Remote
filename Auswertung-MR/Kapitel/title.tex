...
\begin{abstract}
    ...
    Another target of th second part of the experiment is to determine a value for the diffusion coefficient by using the PGSE measurement method. With this method, the diffusion coefficient is determined to a value of $\SI{3,11(26)e-9}{\frac{\m^2}{s}}$
