...
%         \input{plots/2DMRI600.tex}
%         % \caption{2DMRI T2 $\SI{200}{\milli\second}$}
%     \end{subfigure}
%     \begin{subfigure}[t]{0.25\textwidth}
%         \input{plots/2DMRI1300.tex}
%         % \caption{2DMRI T2 $\SI{1300}{\milli\second}$}
%     \end{subfigure}
%     \begin{subfigure}[b]{0.25\textwidth}
%         \input{plots/2DMRI2100.tex}
%         % \caption{2DMRI T2 $\SI{2100}{\milli\second}$}
%     \end{subfigure}
%     \begin{subfigure}[b]{0.25\textwidth}
%         \input{plots/2DMRI2800.tex}
%         % \caption{2DMRI T2 $\SI{2800}{\milli\second}$}
%     \end{subfigure}
%     \label{fig:2DMRIT1}
% \end{figure}
% \begin{figure}[H]
...
%     \caption{Links oben: ;\\ Rechts oben: 2DMRI T2 $\SI{250}{\milli\second}$;\\
