...
set ylabel "Amplitude in $\\SI{\\mycro\\volt}$"
set xlabel "time in $\\SI{\\sec}$"
set xrange [x_min:x_max]
set yrange [y_min:y_max]


#plot dataPTH using 1:2 ls 2 ps 3 lw 3 notitle
plot dataPTH using 1:2 lt 5 lc 15 w lines title "FID measured Spectrum bevore calibration"