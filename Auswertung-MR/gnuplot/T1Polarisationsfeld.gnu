...
plot dataPTH using 1:2 ls 2 ps 3 lw 3 title "measured values from the $T_{1,B_P}$ " , S(x) ls 8 lw 3 title "\\textsc{Keine Ahnung}-Fit $S_0 *[1-exp(-x/T_1)]$ with $T_1=\\SI[2912.88][\mili\sec]$"