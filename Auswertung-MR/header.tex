...
\sisetup{exponent-product = \cdot}                      %   Zehnerpotenzen werden mit Punkt statt Kreuz geschrieben
\usepackage[version=3]{mhchem}                          %   zur einfachen Darstellung chemischer Formeln